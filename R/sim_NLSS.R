...
#'
#' @examples
sim_NLSS = function(n_node = 50, n = 40, alpha_0 = 0.5, alpha_1 = 0.1 ){
  ...
  A = rdirichlet(n,c(alpha_0*rep(1,q-1),alpha_1))
...
#' @export
sim_NLSS2 = function(n_node = 50, n = 40, alpha_0 = c(0.5,0.5,0.5), alpha_1 = 0.1 ){
